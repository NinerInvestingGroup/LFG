...
export function TripBasics({ tripData, updateTripData }: TripBasicsProps) {
  ...
  const popularDestinations = [
    { name: "Bali, Indonesia", image: "/placeholder.svg?height=100&width=150", type: "Beach Paradise" },
    { name: "Tokyo, Japan", image: "/placeholder.svg?height=100&width=150", type: "Cultural Adventure" },
    { name: "Paris, France", image: "/placeholder.svg?height=100&width=150", type: "City Romance" },
    { name: "Iceland", image: "/placeholder.svg?height=100&width=150", type: "Nature Adventure" },
    { name: "New York, USA", image: "/placeholder.svg?height=100&width=150", type: "Urban Experience" },
    { name: "Santorini, Greece", image: "/placeholder.svg?height=100&width=150", type: "Island Getaway" },
  ]
          ...
          {tripData.coverPhoto ? (
            <div className="space-y-4">
              <div className="relative w-full h-32 sm:h-40 lg:h-48 rounded-lg overflow-hidden">
                <NextImage
                  src={URL.createObjectURL(tripData.coverPhoto) || "/placeholder.svg"}
                  alt="Trip cover"
                  fill
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
                ...
                <Button
                  ...
                  className="text-destructive hover:text-destructive-600 w-full sm:w-auto"
                >
                  Remove
                </Button>
              </div>
