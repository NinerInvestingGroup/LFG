...
import type { TripData } from "../trip-creation-wizard"
                ...
                <div className="flex flex-wrap gap-2">
                  {tripData.emailInvites.map((email) => (
                    ...
                    >
                      ...
                      <button onClick={() => removeEmailInvite(email)} className="hover:text-destructive flex-shrink-0">
                        <X className="w-3 h-3" />
                      </button>
                    </Badge>
                  ))}
                ...
                <div className="flex flex-wrap gap-2">
                  {tripData.phoneInvites.map((phone) => (
                    ...
                    >
                      ...
                      <button onClick={() => removePhoneInvite(phone)} className="hover:text-destructive flex-shrink-0">
                        <X className="w-3 h-3" />
                      </button>
                    </Badge>
                  ))}
      ...
      <Card className="border-2 border-warning-200 bg-warning-50">
        <CardContent className="p-4 sm:p-6">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <Badge className="bg-warning text-white text-xs">Optional</Badge>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-lg p-3 sm:p-4 border border-warning-200">
            ...
            <Button variant="outline" className="border-2 border-warning bg-transparent w-full sm:w-auto">
        ...
        <CardContent className="p-4 sm:p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center space-x-2">
              ...
              <Badge className="bg-success text-white text-xs">Professional Help</Badge>
            </div>
            <Switch
          ...
          {tripData.needsAdvisor && (
            <div className="space-y-4 mt-4">
              <div className="bg-success-50 rounded-lg p-3 sm:p-4 border border-success-200">
                <div className="flex items-center space-x-2 mb-2">
                  <Star className="w-4 h-4 text-success" />
                  <span className="font-medium text-success-800 text-sm sm:text-base">Why use a travel advisor?</span>
                </div>
                <ul className="text-xs sm:text-sm text-success-700 space-y-1">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  >
                    <SelectTrigger className="border-2 focus:border-success h-12">
                ...
                <div>
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
                    <Input
                      ...
                      className="flex-1 border-2 focus:border-success h-12"
                    />
