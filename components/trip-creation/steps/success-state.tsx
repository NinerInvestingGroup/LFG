...
export function SuccessState({ tripData }: SuccessStateProps) {
  ...
  const quickActions = [
    ...
    },
    {
      ...
      icon: DollarSign,
      color: "bg-success hover:bg-success-600 text-white",
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-secondary-50 relative overflow-hidden">
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8 py-6 sm:py-12 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-success to-success-600 rounded-full flex items-center justify-center mx-auto mb-4 sm:mb-6 animate-pulse">
          ...
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3">
            ...
            <Badge className="bg-success text-white px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm">
        ...
        <Card className="shadow-lg sm:shadow-2xl border-0 bg-white/90 backdrop-blur-sm mb-8 sm:mb-12">
          <CardContent className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-center">
              ...
              <div className="p-3 sm:p-4 bg-success-50 rounded-lg">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 text-xs sm:text-sm">
            ...
            <div className="p-3 sm:p-4 bg-white rounded-lg shadow-sm">
              <div className="w-6 h-6 sm:w-8 sm:h-8 bg-success text-white rounded-full flex items-center justify-center mx-auto mb-2 text-xs sm:text-sm font-bold">
                3
              </div>
