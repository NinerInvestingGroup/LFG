        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 max-w-md">
            ...
            <div className="space-y-2">
              ...
              <Input placeholder="Click to focus" className="min-h-[44px] ring-2 ring-primary" />
            </div>

            <div className="space-y-2">
              <Label>Error State</Label>
              <Input placeholder="Invalid input" className="min-h-[44px] border-destructive focus:ring-destructive" />
