...
const colorGroups = [
  ...
  {
    name: "Success - Green",
    colors: [{ name: "success-500", value: "#10B981", hex: "#10B981" }],
  },
  {
    name: "Warning - Amber",
  ...
  {
    name: "Error - Red",
    colors: [{ name: "error-500", value: "#EF4444", hex: "#EF4444" }],
  },
  {
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 lg:grid-cols-10 gap-4">
              {group.colors.map((color) => (
                <div key={color.name} className="space-y-2">
                  <div className="w-full h-16 rounded-lg border shadow-sm" style={{ backgroundColor: color.value }} />
