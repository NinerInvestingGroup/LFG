      ...
      <CardContent className="space-y-8">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Badge className="bg-danger text-white">Cancelled</Badge>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="relative">
              ...
              <Badge className="absolute -top-2 -right-2 bg-danger text-white text-xs min-w-[20px] h-5 flex items-center justify-center rounded-full">
                3
              </Badge>
            </div>
